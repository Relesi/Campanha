...
@Entity
public class Campanha implements UserDetails {
	...
	private Set<Torcedor> torcedors;
	...
	public Set<Torcedor> getPizzas() {
		return torcedors;
	}

	public void setPizzas(Set<Torcedor> torcedors) {
		this.torcedors = torcedors;
	}
